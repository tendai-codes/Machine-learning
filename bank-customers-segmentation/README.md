...
Source: https://tendaisibanda.dev/ (Bank Customer Segmentation)
...
2. Open `Bank Customers Segmentation.ipynb` in Jupyter.
3. Provide the dataset file expected by the notebook if it is not embedded.
